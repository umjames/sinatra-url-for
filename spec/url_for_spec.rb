...
describe Sinatra::UrlForHelper do
  ...
  it "should handle URLs with placeholders and without extra parameters in them" do
    get "/", :url => "/object/:id/status", :options => {:id => 3}

    last_response.should be_ok
    last_response.body.should == "/object/3/status"
  end
